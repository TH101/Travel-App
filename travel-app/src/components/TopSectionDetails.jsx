...
// import "../assets/styles/topSectionDetails.css";

// const TopSectionDetails = () => {
//   return (
//     <div>
//       <Typography variant="h5" className="typography1">
//         The best deals on the world's best destinations
//       </Typography>
//       <br />
//       <Typography variant="h1" className="typography2">
//         Best travel and destinations
//       </Typography>
//       <Typography variant="body1" className="typography3">
//         With travala you can experience new travel and the best tourist
//         destinations that we have to offer
//       </Typography>
//       <br />
//       <button variant="contained" className="destinationBtn">
//         Our Destination
//       </button>
//       <Button variant="text" className="galleryBtn">
//         Our Gallery
//       </Button>
//     </div>
//   );
